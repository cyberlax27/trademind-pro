...
const BROKERS = {
  xm: { 
    name: "XM (XEMarkets)", 
    docs: "https://www.xm.com/", 
    guide: "1. Go to xm.com → Register account\n2. Login to client cabinet\n3. Go to Settings → API Keys\n4. Generate new API key\n5. Copy key and paste here"
  },
  exness: { 
    name: "Exness", 
    docs: "https://www.exness.com/", 
    guide: "1. Go to exness.com → Open account\n2. Login to personal area\n3. Go to Tools → API Settings\n4. Click 'Create API Token'\n5. Copy token and paste here"
  },
  doto: { 
    name: "Doto Markets", 
    docs: "https://www.dotomarkets.com/", 
    guide: "1. Go to dotomarkets.com → Sign up\n2. Complete verification\n3. Go to Settings → Developer\n4. Generate API credentials\n5. Copy and paste here"
  },
  demo: { 
    name: "Demo Account", 
    docs: "#", 
    guide: "Using built-in $10,000 virtual demo account. No API key needed!"
  }
};
